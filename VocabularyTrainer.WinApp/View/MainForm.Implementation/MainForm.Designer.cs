namespace VocabularyTrainer.WinApp
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			TranslationsLabel = new Label();
			WordToLearnLabel = new Label();
			TranslationsPanel = new FlowLayoutPanel();
			AddMoreInfoButton = new Button();
			PinTranslationsButton = new CheckBox();
			...
			DictAlgorithmLabel = new Label();
			MyDictionariesAlgorithmComboBox = new ComboBox();
			...
			AddNewWordsPage.Controls.Add(TranslationsLabel);
			AddNewWordsPage.Controls.Add(WordToLearnLabel);
			AddNewWordsPage.Controls.Add(TranslationsPanel);
			AddNewWordsPage.Controls.Add(AddMoreInfoButton);
			AddNewWordsPage.Controls.Add(PinTranslationsButton);
			AddNewWordsPage.Controls.Add(InputWordTextBox);
			AddNewWordsPage.ForeColor = Color.Black;
			AddNewWordsPage.Location = new Point(4, 42);
			AddNewWordsPage.Name = "AddNewWordsPage";
			AddNewWordsPage.Padding = new Padding(3);
			AddNewWordsPage.Size = new Size(912, 486);
			...
			AddDataButton.Location = new Point(204, 410);
			AddDataButton.Name = "AddDataButton";
			AddDataButton.Size = new Size(660, 54);
			AddDataButton.TabIndex = 9;
			...
			// TranslationsLabel
			// 
			TranslationsLabel.AutoSize = true;
			TranslationsLabel.Location = new Point(14, 170);
			TranslationsLabel.Name = "TranslationsLabel";
			TranslationsLabel.Size = new Size(153, 33);
			TranslationsLabel.TabIndex = 4;
			...
			// TranslationsPanel
			// 
			TranslationsPanel.AutoScroll = true;
			TranslationsPanel.FlowDirection = FlowDirection.TopDown;
			TranslationsPanel.Location = new Point(204, 162);
			TranslationsPanel.Name = "TranslationsPanel";
			TranslationsPanel.Size = new Size(660, 242);
			TranslationsPanel.TabIndex = 7;
			TranslationsPanel.WrapContents = false;
			// 
			// AddMoreInfoButton
			// 
			AddMoreInfoButton.ForeColor = Color.Black;
			AddMoreInfoButton.Location = new Point(14, 206);
			AddMoreInfoButton.Name = "AddMoreInfoButton";
			AddMoreInfoButton.Size = new Size(164, 40);
			AddMoreInfoButton.TabIndex = 8;
			AddMoreInfoButton.Text = "+ Add";
			AddMoreInfoButton.UseVisualStyleBackColor = true;
			AddMoreInfoButton.Click += AddMoreInfoButton_Click;
			// 
			// PinTranslationsButton
			// 
			PinTranslationsButton.Appearance = Appearance.Button;
			PinTranslationsButton.ForeColor = Color.Black;
			PinTranslationsButton.Location = new Point(14, 252);
			PinTranslationsButton.Name = "PinTranslationsButton";
			PinTranslationsButton.Size = new Size(164, 40);
			PinTranslationsButton.TabIndex = 12;
			PinTranslationsButton.Text = "Pin";
			PinTranslationsButton.TextAlign = ContentAlignment.MiddleCenter;
			PinTranslationsButton.UseVisualStyleBackColor = true;
			PinTranslationsButton.CheckedChanged += PinTranslationsButton_CheckedChanged;
			// 
			// InputWordTextBox
			// 
			InputWordTextBox.Location = new Point(204, 109);
			InputWordTextBox.Name = "InputWordTextBox";
			InputWordTextBox.Size = new Size(660, 41);
			...
			MyDictionariesPage.Controls.Add(DictAlgorithmLabel);
			MyDictionariesPage.Controls.Add(MyDictionariesAlgorithmComboBox);
			...
			WordCountLabel.Location = new Point(6, 205);
			...
			// DictAlgorithmLabel
			// 
			DictAlgorithmLabel.AutoSize = true;
			DictAlgorithmLabel.ForeColor = Color.Black;
			DictAlgorithmLabel.Location = new Point(278, 112);
			DictAlgorithmLabel.Name = "DictAlgorithmLabel";
			DictAlgorithmLabel.Size = new Size(125, 33);
			DictAlgorithmLabel.TabIndex = 9;
			DictAlgorithmLabel.Text = "Algorithm";
			// 
			// MyDictionariesAlgorithmComboBox
			// 
			MyDictionariesAlgorithmComboBox.DropDownStyle = ComboBoxStyle.DropDownList;
			MyDictionariesAlgorithmComboBox.ForeColor = Color.Black;
			MyDictionariesAlgorithmComboBox.Location = new Point(400, 109);
			MyDictionariesAlgorithmComboBox.Name = "MyDictionariesAlgorithmComboBox";
			MyDictionariesAlgorithmComboBox.Size = new Size(372, 41);
			MyDictionariesAlgorithmComboBox.TabIndex = 10;
			// 
			// AddDictionaryButton
			// 
			AddDictionaryButton.ForeColor = Color.Black;
			AddDictionaryButton.Location = new Point(278, 158);
			...
			UpdateDictionaryButton.Location = new Point(450, 158);
			...
			DeleteDictionaryButton.Location = new Point(648, 158);
		...
		private FlowLayoutPanel TranslationsPanel;
		private Button AddMoreInfoButton;
		private CheckBox PinTranslationsButton;
		...
		private Label DictAlgorithmLabel;
		private ComboBox MyDictionariesAlgorithmComboBox;
